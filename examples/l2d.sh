...
# create dems
l2d_createdems Classified_LAS/*c3.las --dsm 0.56419 --dtm 0.56419 1.0 1.4142 2.0 2.5 3.0 --bounds $BOUNDS --epsg $EPSG --outdir DEMs

# create vrt of photos
gdalbuildvt photos_lowres.vrt lowres_photos/*.tif
