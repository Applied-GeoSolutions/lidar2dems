...
cd LASzip; git checkout tags/2.0.2 ; mkdir build; cd build; cmake -G "Unix Makefiles" ../
...
# install lidar2dems
sudo pip install https://github.com/Applied-GeoSolutions/gippy/archive/v0.3.9.tar.gz
